...
exports.db = void 0;
const _1 = require("./");
Object.defineProperty(exports, "db", { enumerable: true, get: function () { return _1.db; } });
...
const createDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield _1.db.raw(`USE \`${process.env.DB_NAME}\``);
});
const createTables = () => __awaiter(void 0, void 0, void 0, function* () {
    if (!(yield _1.db.schema.hasTable("medidas"))) {
        yield _1.db.schema.createTable("medidas", (table) => {
            table.integer("id").primary();
            table.string("nome", 15);
            table.string("sigla", 10);
        });
    }
    if (!(yield _1.db.schema.hasTable("produtos"))) {
        yield _1.db.schema.createTable("produtos", (table) => {
    ...
    if (!(yield _1.db.schema.hasTable("lotes"))) {
        yield _1.db.schema.createTable("lotes", (table) => {
            table.string("id", 26).primary();
    ...
    if (!(yield _1.db.schema.hasTable("fornecedores"))) {
        yield _1.db.schema.createTable("fornecedores", (table) => {
            table.string("id", 26).primary();
    ...
    if (!(yield _1.db.schema.hasTable("produtosfornecidos"))) {
        yield _1.db.schema.createTable("produtosfornecidos", (table) => {
            table.string("id_produto", 26).notNullable();
    ...
    if (!(yield _1.db.schema.hasTable("tiposcontatos"))) {
        yield _1.db.schema.createTable("tiposcontatos", (table) => {
            table.integer("id").primary();
            table.string("nome", 10).notNullable().unique();
        });
    }
    if (!(yield _1.db.schema.hasTable("contatos"))) {
        yield _1.db.schema.createTable("contatos", (table) => {
            table.string("id", 26).primary();
    ...
    if (!(yield _1.db.schema.hasTable("contatosfornecedores"))) {
        yield _1.db.schema.createTable("contatosfornecedores", (table) => {
            table.string("id_fornecedor", 26).notNullable();
    ...
    if (!(yield _1.db.schema.hasTable("usuarios"))) {
        yield _1.db.schema.createTable("usuarios", (table) => {
            table.string("id", 26).primary();
            table.string("nome", 80).nullable();
            table.date("dt_nascimento").nullable();
        });
    }
    if (!(yield _1.db.schema.hasTable("autenticacao"))) {
        yield _1.db.schema.createTable("autenticacao", (table) => {
            table.string("email", 60).primary();
            table.string("senha", 60).notNullable();
            table.boolean("email_validado").defaultTo(0).notNullable();
        });
    }
    if (!(yield _1.db.schema.hasTable("login"))) {
        yield _1.db.schema.createTable("login", (table) => {
            table.string("id_usuario", 26).notNullable();
            table.string("email", 60).notNullable();
            table.timestamp("data_ultimo_acesso").defaultTo(_1.db.fn.now());
    ...
    if (!(yield _1.db.schema.hasTable("contatosusuarios"))) {
        yield _1.db.schema.createTable("contatosusuarios", (table) => {
            table.string("id_usuario", 26).notNullable();
            table.string("id_contato", 26).notNullable();
    ...
    if (!(yield _1.db.schema.hasTable("movimentacoes"))) {
        yield _1.db.schema.createTable("movimentacoes", (table) => {
            table.string("id_produto", 26).notNullable();
            table.string("id_usuario", 26).notNullable();
            table.string("email", 60).notNullable();
    ...
    if (!(yield _1.db.schema.hasTable("vendas"))) {
        yield _1.db.schema.createTable("vendas", (table) => {
            ...
            table.timestamp("data_venda").defaultTo(_1.db.fn.now()).notNullable();
        });
    }
    if (!(yield _1.db.schema.hasTable("produtosvendas"))) {
        yield _1.db.schema.createTable("produtosvendas", (table) => {
...
const insertDefaultData = () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, _1.db)("tiposcontatos")
        .insert([
        { id: 1, nome: "tel" },
        { id: 2, nome: "site" },
        { id: 3, nome: "email" },
